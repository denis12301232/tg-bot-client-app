<template>
  <QDialog v-model="chat">
    <MeetChat :messages="messages" :abonents="abonents" @my-msg="(msg) => messages.push(msg)" />
  </QDialog>
  <MeetVideos ref="meetVideosRef" :abonents="abonents" :meet-id="meetId" @chat-open="chat = !chat" />
</template>
