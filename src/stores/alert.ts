...
import { reviver, replacer } from '@/util';
...
export const useAlertStore = defineStore('alert', () => {
  ...
  const notices = ref<Map<string, Notice>>(new Map(JSON.parse(localStorage.getItem('notices') || '[]', reviver)));
  ...
  watchEffect(() => localStorage.setItem('notices', JSON.stringify(notices.value, replacer)));
